...
###7 webView设置
###8 图片轮播器 用到了handlerdelayed发送延迟消息

------------------------------------------------
###update:
###2016/02/28
####修改了一处点击事件的BUG和一些屏幕适配,代码适配的问题,添加了后台推送消息功能 基于XMPP协议 
####修改了几处尺寸适配问题



##PS:
###这是我学习安卓用于练手的项目 难度系数不是很高 还有很多可以优化的地方,希望以后再工作中学到更多的知识来优化这个项目让它变得
###更有学习价值分享给大家. 更多教程请移步我的博客[AceIsSunshineRain] (http://www.cnblogs.com/AceIsSunshineRain/)
###自己实现了一个三级缓存但xUtils已经实现了 所以就没有加入项目里 但写在博客里了 大家可以去看 还有一些项目中遇到的问题也在博客中写出
###关于要自学安卓的也可以在博客中站内信我 我可以把学习的路和资源告诉你,加油!
